export const data = [
  {
    ...
    desc: `사용자가 보유한 보험의 정보를 확인할 수 있는 상세 화면 서비스입니다. \n 아웃바운드 메시지 유입 사용자를 대상으로 보험 진단, 병원비 청구, 보험 콘텐츠 등 관련 기능으로 자연스럽게 확장 유도하는 허브 역할을 하여 매출 증대에 기여하기 위하여 UI/UX 개편 진행`,
    role: [
      {
        category: "UI/UX 구현",
        details: [
  ...
  },
  {
    ...
    date: "",
    desc: "보험 진단 방문자의 상담 전환율을 극대화하기 위한 프로젝트로, 보장 금액 및 가입 금액 시각화 차트를 추가하여 이해도를 높이고, 하루 최대 3,000건 상담 연결, 매출 10배 이상 증가 성과를 달성했습니다",
    role: [],
    skill: ["React", "TypeScript", "scss (css module)", "Storybook"],
  },
  {
